...
public class v1_9_R1 implements NMS
{
    public static NBTTagCompound getTag(final ItemStack arg0, final boolean create) {
        ...
        try {
            ...
            item = (net.minecraft.server.v1_9_R1.ItemStack)handle.get(arg0);
        }
        catch (Exception e) {
    ...
    public void playParticle(final Player p, final boolean normal) {
        if (normal) {
            ...
            final String e = SelectedParticle.getSelectetParticle(p.getUniqueId().toString()).getParticle();
